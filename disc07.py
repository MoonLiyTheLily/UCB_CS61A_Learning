...
class Keyboard:
    ...
    def __init__(self):
        self.typed = []
        self.keys = {key:Button(key,lambda x:None) for key in LOWERCASE_LETTERS}  # Try a dictionary comprehension!
...
class WinkingBear(Bear):
    ...
    def next_eye(self):
        "*** YOUR CODE HERE ***"
        self.eye_status=not self.eye_status
        return Eye(self.eye_status)
#the code above have passed the doctest.
